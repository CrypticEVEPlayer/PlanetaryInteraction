...
The fuel blcok PI templates attempts to use 3 factory planets to get all the P2s and P3s required for fuel block production. Command center upgrades V is r4equired for this setup. For Fuel blocks, coolant is needed at about a 2:1 ratio to the mechanical parts/enriched Uranium requirements. Nothing is perfect in PI production and you will most likely have some left over. All 3 factories run for the same amount a time and get refreshed once per week.

Diagram:

![Factory Setup](Images/Setup.png)
